...
var DisplayProcessor = (function () {
    ...
    DisplayProcessor.prototype.displaySuiteDone = function (suite, log) {
        return log;
    };
    DisplayProcessor.prototype.displaySpecStarted = function (spec, log) {
        return log;
    };
    DisplayProcessor.prototype.displaySpecDone = function (spec, log) {
        return log;
    };
    ...
    DisplayProcessor.prototype.displaySummary = function (spec, log, metrics) {
        return log;
    };
    DisplayProcessor.prototype.displayJasmineDone = function (spec, log) {
        return log;
    };
